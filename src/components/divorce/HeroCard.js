    ...
    return (
        <div className="container-fluid  ">
            <div className="row d-md-flex d-none w-90 mx-auto justify-content-center">
                <div className='border light-gray rounded-3 mt-4 text-center' style={{ width: "350px", padding: "10px 10px" }}>
                ...
                <div className='border light-gray rounded-3 mt-4 mx-3 text-center' style={{ width: "350px", padding: "10px 10px" }}>
                    <p className='fs-22 fw-medium mb-0'>
